...
import { Menu, X, LayoutDashboard, Users, Flag, Trophy, LogOut, TrendingUp } from "lucide-react";
...
export default function Header() {
    ...
    const navItems = [
        ...
        { href: `/${locale}/leaderboard`, label: t('leaderboard'), icon: TrendingUp, adminOnly: false }, // Added Leaderboard link
        { href: `/${locale}/profile`, label: 'Profile', icon: Users, adminOnly: false },
