...
export default function ProfilePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // If this was a first-time setup (no previous profile), redirect to dashboard
            if (!memberProfile) {
                setTimeout(() => {
                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="bg-gradient-to-r from-emerald-600 to-green-700 p-8 text-white">
                            <h1 className="text-3xl font-bold mb-2">
                                {memberProfile ? 'Edit Profile' : 'Complete Your Profile'}
                            </h1>
                            <p className="text-emerald-100">
                                {memberProfile
                                    ? 'Update your personal information and handicap.'
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label htmlFor="handicap" className="block text-sm font-medium text-gray-700 mb-1">Handicap</label>
                                            <div className="relative">
                                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <div className="pt-4">
                                    ...
                                    >
                                        {isSubmitting ? (
                                            ...
                                            <>
                                                <Save size={20} />
                                                {memberProfile ? 'Save Changes' : 'Create Profile & Continue'}
                                            </>
                                        )}
                                    </button>
                                </div>
